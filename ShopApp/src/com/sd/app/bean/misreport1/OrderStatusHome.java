 ...
 * @see com.sd.app.bean.misreport1.OrderStatus
...
public class OrderStatusHome {
	...
	public OrderStatus findById(com.sd.app.bean.misreport1.OrderStatusId id) {
		log.debug("getting OrderStatus instance with id: " + id);
		try {
			OrderStatus instance = (OrderStatus) sessionFactory.getCurrentSession().get("com.sd.app.bean.misreport1.OrderStatus", id);
			if (instance == null) {
	...
	public List<OrderStatus> findByExample(OrderStatus instance) {
		...
		try {
			List<OrderStatus> results = (List<OrderStatus>) sessionFactory.getCurrentSession()
					.createCriteria("com.sd.app.bean.misreport1.OrderStatus").add(create(instance)).list();
