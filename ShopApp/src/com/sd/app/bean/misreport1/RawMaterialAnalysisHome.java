 ...
 * @see com.sd.app.bean.misreport1.RawMaterialAnalysis
...
public class RawMaterialAnalysisHome {
	...
	public RawMaterialAnalysis findById(com.sd.app.bean.misreport1.RawMaterialAnalysisId id) {
		...
		try {
			RawMaterialAnalysis instance = (RawMaterialAnalysis) sessionFactory.getCurrentSession().get(
					"com.sd.app.bean.misreport1.RawMaterialAnalysis", id);
			if (instance == null) {
	...
	public List<RawMaterialAnalysis> findByExample(RawMaterialAnalysis instance) {
		...
		try {
			List<RawMaterialAnalysis> results = (List<RawMaterialAnalysis>) sessionFactory.getCurrentSession()
					.createCriteria("com.sd.app.bean.misreport1.RawMaterialAnalysis").add(create(instance)).list();
