...
public class MediaHome {
	...
	public Media findById(java.lang.String id) {
		log.debug("getting Media instance with id: " + id);
		try {
			Media instance = (Media) sessionFactory.getCurrentSession().get("com.sd.app.bean.sfa.Media", id);
			if (instance == null) {
	...
	public List<Media> findByExample(Media instance) {
		...
		try {
			List<Media> results = (List<Media>) sessionFactory.getCurrentSession().createCriteria("com.sd.app.bean.sfa.Media").add(create(instance))
					.list();
