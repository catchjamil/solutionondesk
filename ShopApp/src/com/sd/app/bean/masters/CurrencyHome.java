 ...
 * @see com.sd.app.bean.masters.Currency
...
public class CurrencyHome {
	...
	public Currency findById(com.sd.app.bean.masters.CurrencyId id) {
		log.debug("getting Currency instance with id: " + id);
		try {
			Currency instance = (Currency) sessionFactory.getCurrentSession().get("com.sd.app.bean.masters.Currency", id);
			if (instance == null) {
	...
	public List<Currency> findByExample(Currency instance) {
		...
		try {
			List<Currency> results = (List<Currency>) sessionFactory.getCurrentSession().createCriteria("com.sd.app.bean.masters.Currency")
