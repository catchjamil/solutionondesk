 ...
 * @see com.sd.app.bean.masters.StandType
...
public class StandTypeHome {
	...
	public StandType findById(com.sd.app.bean.masters.StandTypeId id) {
		log.debug("getting StandType instance with id: " + id);
		try {
			StandType instance = (StandType) sessionFactory.getCurrentSession().get("com.sd.app.bean.masters.StandType", id);
			if (instance == null) {
	...
	public List<StandType> findByExample(StandType instance) {
		...
		try {
			List<StandType> results = (List<StandType>) sessionFactory.getCurrentSession().createCriteria("com.sd.app.bean.masters.StandType")
