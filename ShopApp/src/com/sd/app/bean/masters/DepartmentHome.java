 ...
 * @see com.sd.app.bean.masters.Department
...
public class DepartmentHome {
	...
	public Department findById(com.sd.app.bean.masters.DepartmentId id) {
		log.debug("getting Department instance with id: " + id);
		try {
			Department instance = (Department) sessionFactory.getCurrentSession().get("com.sd.app.bean.masters.Department", id);
			if (instance == null) {
	...
	public List<Department> findByExample(Department instance) {
		...
		try {
			List<Department> results = (List<Department>) sessionFactory.getCurrentSession().createCriteria("com.sd.app.bean.masters.Department")
