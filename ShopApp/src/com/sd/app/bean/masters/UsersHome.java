 ...
 * @see com.sd.app.bean.masters.Users
...
public class UsersHome {
	...
	public Users findById(com.sd.app.bean.masters.UsersId id) {
		log.debug("getting Users instance with id: " + id);
		try {
			Users instance = (Users) sessionFactory.getCurrentSession().get("com.sd.app.bean.masters.Users", id);
			if (instance == null) {
	...
	public List<Users> findByExample(Users instance) {
		...
		try {
			List<Users> results = (List<Users>) sessionFactory.getCurrentSession().createCriteria("com.sd.app.bean.masters.Users")
