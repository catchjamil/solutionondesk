 ...
 * @see com.sd.app.bean.company.Company
...
public class CompanyHome {
	...
	public Company findById(com.sd.app.bean.company.CompanyId id) {
		log.debug("getting Company instance with id: " + id);
		try {
			Company instance = (Company) sessionFactory.getCurrentSession().get("com.sd.app.bean.company.Company", id);
			if (instance == null) {
	...
	public List<Company> findByExample(Company instance) {
		...
		try {
			List<Company> results = (List<Company>) sessionFactory.getCurrentSession().createCriteria("com.sd.app.bean.company.Company")
