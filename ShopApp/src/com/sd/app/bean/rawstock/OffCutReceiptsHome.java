 ...
 * @see com.sd.app.bean.rawstock.OffCutReceipts
...
public class OffCutReceiptsHome {
	...
	public OffCutReceipts findById(com.sd.app.bean.rawstock.OffCutReceiptsId id) {
		log.debug("getting OffCutReceipts instance with id: " + id);
		try {
			OffCutReceipts instance = (OffCutReceipts) sessionFactory.getCurrentSession().get("com.sd.app.bean.rawstock.OffCutReceipts", id);
			if (instance == null) {
	...
	public List<OffCutReceipts> findByExample(OffCutReceipts instance) {
		...
		try {
			List<OffCutReceipts> results = (List<OffCutReceipts>) sessionFactory.getCurrentSession()
					.createCriteria("com.sd.app.bean.rawstock.OffCutReceipts").add(create(instance)).list();
