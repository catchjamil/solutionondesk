 ...
 * @see com.sd.app.bean.debitenote.InvMaster
...
public class InvMasterHome {
	...
	public InvMaster findById(com.sd.app.bean.debitenote.InvMasterId id) {
		log.debug("getting InvMaster instance with id: " + id);
		try {
			InvMaster instance = (InvMaster) sessionFactory.getCurrentSession().get("com.sd.app.bean.debitenote.InvMaster", id);
			if (instance == null) {
	...
	public List<InvMaster> findByExample(InvMaster instance) {
		...
		try {
			List<InvMaster> results = (List<InvMaster>) sessionFactory.getCurrentSession().createCriteria("com.sd.app.bean.debitenote.InvMaster")
