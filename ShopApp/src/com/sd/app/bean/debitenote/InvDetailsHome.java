 ...
 * @see com.sd.app.bean.debitenote.InvDetails
...
public class InvDetailsHome {
	...
	public InvDetails findById(com.sd.app.bean.debitenote.InvDetailsId id) {
		log.debug("getting InvDetails instance with id: " + id);
		try {
			InvDetails instance = (InvDetails) sessionFactory.getCurrentSession().get("com.sd.app.bean.debitenote.InvDetails", id);
			if (instance == null) {
	...
	public List<InvDetails> findByExample(InvDetails instance) {
		...
		try {
			List<InvDetails> results = (List<InvDetails>) sessionFactory.getCurrentSession().createCriteria("com.sd.app.bean.debitenote.InvDetails")
