...
/**
 * ReturnableChallanId generated by hbm2java
 */
public class ReturnableChallanId implements java.io.Serializable {
	...
	public ReturnableChallanId() {
	}

	public ReturnableChallanId(Integer idNo, String coCode, Integer challanNo, Date challanDate, Integer pcode, String transporter, String vehicleNo,
			String grNo, Integer authBy, String particulars, String uom, Float qty, Float rate, Float amount, String remarks, Integer gpNo,
			Float balQty, String prepBy) {
		this.idNo = idNo;
		this.coCode = coCode;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ReturnableChallanId))
			return false;
		ReturnableChallanId castOther = (ReturnableChallanId) other;
