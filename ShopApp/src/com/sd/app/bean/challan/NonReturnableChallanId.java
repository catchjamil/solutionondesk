...
/**
 * NonReturnableChallanId generated by hbm2java
 */
public class NonReturnableChallanId implements java.io.Serializable {
	...
	public NonReturnableChallanId() {
	}

	public NonReturnableChallanId(Integer idNo, String coCode, Integer challanNo, Date challanDate, Integer pcode, String transporter,
			String vehicleNo, String grNo, Integer authBy, String particulars, String uom, Float qty, Float rate, Float amount, String remarks,
			Integer gpNo, String receiptsBy, String prepBy) {
		this.idNo = idNo;
		this.coCode = coCode;
	...
	public String getReceiptsBy() {
		return this.receiptsBy;
	}

	public void setReceiptsBy(String receiptsBy) {
		this.receiptsBy = receiptsBy;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof NonReturnableChallanId))
			return false;
		NonReturnableChallanId castOther = (NonReturnableChallanId) other;
		...
		return ((this.getIdNo() == castOther.getIdNo()) || (this.getIdNo() != null && castOther.getIdNo() != null && this.getIdNo().equals(
				...
				&& ((this.getGpNo() == castOther.getGpNo()) || (this.getGpNo() != null && castOther.getGpNo() != null && this.getGpNo().equals(
						castOther.getGpNo())))
				&& ((this.getReceiptsBy() == castOther.getReceiptsBy()) || (this.getReceiptsBy() != null && castOther.getReceiptsBy() != null && this
						.getReceiptsBy().equals(castOther.getReceiptsBy())))
	...
	public int hashCode() {
		...
		result = 37 * result + (getReceiptsBy() == null ? 0 : this.getReceiptsBy().hashCode());
