 ...
 * @see com.sd.app.bean.reportdata.MonthlySales
...
public class MonthlySalesHome {
	...
	public MonthlySales findById(com.sd.app.bean.reportdata.MonthlySalesId id) {
		log.debug("getting MonthlySales instance with id: " + id);
		try {
			MonthlySales instance = (MonthlySales) sessionFactory.getCurrentSession().get("com.sd.app.bean.reportdata.MonthlySales", id);
			if (instance == null) {
	...
	public List<MonthlySales> findByExample(MonthlySales instance) {
		...
		try {
			List<MonthlySales> results = (List<MonthlySales>) sessionFactory.getCurrentSession()
					.createCriteria("com.sd.app.bean.reportdata.MonthlySales").add(create(instance)).list();
