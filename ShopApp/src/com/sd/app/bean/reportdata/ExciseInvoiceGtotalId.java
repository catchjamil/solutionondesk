...
/**
 * ExciseInvoiceGtotalId generated by hbm2java
 */
public class ExciseInvoiceGtotalId implements java.io.Serializable {
	...
	public ExciseInvoiceGtotalId() {
	}

	public ExciseInvoiceGtotalId(String coCode, Float sqMt, Double basicForExcise, Float exciseAmount, Float ecessOnDuty, Float staxAmount,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ExciseInvoiceGtotalId))
			return false;
		ExciseInvoiceGtotalId castOther = (ExciseInvoiceGtotalId) other;
