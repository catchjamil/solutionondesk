 ...
 * @see com.sd.app.bean.reportdata.Order
...
public class OrderHome {
	...
	public Order findById(com.sd.app.bean.reportdata.OrderId id) {
		log.debug("getting Order instance with id: " + id);
		try {
			Order instance = (Order) sessionFactory.getCurrentSession().get("com.sd.app.bean.reportdata.Order", id);
			if (instance == null) {
	...
	public List<Order> findByExample(Order instance) {
		...
		try {
			List<Order> results = (List<Order>) sessionFactory.getCurrentSession().createCriteria("com.sd.app.bean.reportdata.Order")
