...
/**
 * ReadyId generated by hbm2java
 */
public class ReadyId implements java.io.Serializable {
	...
	public ReadyId(Integer idNo, Date entryDate, String orderNo, Short itNo, Float thick, String icode, String bend, String tough, Float width,
			...
			Short cutOutNos, String remarks, String material) {
		this.idNo = idNo;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ReadyId))
			return false;
		ReadyId castOther = (ReadyId) other;
