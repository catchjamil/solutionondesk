 ...
 * @see com.sd.app.bean.wipfile.Stickers
...
public class StickersHome {
	...
	public Stickers findById(com.sd.app.bean.wipfile.StickersId id) {
		log.debug("getting Stickers instance with id: " + id);
		try {
			Stickers instance = (Stickers) sessionFactory.getCurrentSession().get("com.sd.app.bean.wipfile.Stickers", id);
			if (instance == null) {
	...
	public List<Stickers> findByExample(Stickers instance) {
		...
		try {
			List<Stickers> results = (List<Stickers>) sessionFactory.getCurrentSession().createCriteria("com.sd.app.bean.wipfile.Stickers")
