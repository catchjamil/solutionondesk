 ...
 * @see com.sd.app.bean.lamproduction.ReportTough
...
public class ReportToughHome {
	...
	public ReportTough findById(com.sd.app.bean.lamproduction.ReportToughId id) {
		log.debug("getting ReportTough instance with id: " + id);
		try {
			ReportTough instance = (ReportTough) sessionFactory.getCurrentSession().get("com.sd.app.bean.lamproduction.ReportTough", id);
			if (instance == null) {
	...
	public List<ReportTough> findByExample(ReportTough instance) {
		...
		try {
			List<ReportTough> results = (List<ReportTough>) sessionFactory.getCurrentSession()
					.createCriteria("com.sd.app.bean.lamproduction.ReportTough").add(create(instance)).list();
