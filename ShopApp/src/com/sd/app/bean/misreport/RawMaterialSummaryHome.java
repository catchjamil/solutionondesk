 ...
 * @see com.sd.app.bean.misreport.RawMaterialSummary
...
public class RawMaterialSummaryHome {
	...
	public RawMaterialSummary findById(com.sd.app.bean.misreport.RawMaterialSummaryId id) {
		log.debug("getting RawMaterialSummary instance with id: " + id);
		try {
			RawMaterialSummary instance = (RawMaterialSummary) sessionFactory.getCurrentSession().get("com.sd.app.bean.misreport.RawMaterialSummary",
					id);
			if (instance == null) {
	...
	public List<RawMaterialSummary> findByExample(RawMaterialSummary instance) {
		...
		try {
			List<RawMaterialSummary> results = (List<RawMaterialSummary>) sessionFactory.getCurrentSession()
					.createCriteria("com.sd.app.bean.misreport.RawMaterialSummary").add(create(instance)).list();
