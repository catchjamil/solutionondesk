...
// Generated Nov 22, 2014 1:13:29 PM by Hibernate Tools 3.4.0.CR1
 ...
 * @see com.sd.app.bean.proforma.PinvDetails
...
public class PinvDetailsHome {
	...
	public PinvDetails findById(com.sd.app.bean.proforma.PinvDetailsId id) {
		log.debug("getting PinvDetails instance with id: " + id);
		try {
			PinvDetails instance = (PinvDetails) sessionFactory.getCurrentSession().get("com.sd.app.bean.proforma.PinvDetails", id);
			if (instance == null) {
	...
	public List<PinvDetails> findByExample(PinvDetails instance) {
		...
		try {
			List<PinvDetails> results = (List<PinvDetails>) sessionFactory.getCurrentSession().createCriteria("com.sd.app.bean.proforma.PinvDetails")
