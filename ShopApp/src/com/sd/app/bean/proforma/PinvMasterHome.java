 ...
 * @see com.sd.app.bean.proforma.PinvMaster
...
public class PinvMasterHome {
	...
	public PinvMaster findById(com.sd.app.bean.proforma.PinvMasterId id) {
		log.debug("getting PinvMaster instance with id: " + id);
		try {
			PinvMaster instance = (PinvMaster) sessionFactory.getCurrentSession().get("com.sd.app.bean.proforma.PinvMaster", id);
			if (instance == null) {
	...
	public List<PinvMaster> findByExample(PinvMaster instance) {
		...
		try {
			List<PinvMaster> results = (List<PinvMaster>) sessionFactory.getCurrentSession().createCriteria("com.sd.app.bean.proforma.PinvMaster")
