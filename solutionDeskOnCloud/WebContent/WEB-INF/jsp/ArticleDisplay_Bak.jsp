...
<script src="<%=request.getContextPath()%>/js/jquery.js"></script>
    ...
    var param = "name='test'&type=chapter";
					...
					<tr>
						<td>
							<table border="0" width="100%">
								...
								<%List<ArticleDTO> articlesDetails = (List<ArticleDTO>)request.getAttribute("articlesDetails");
								
								for(ArticleDTO articleDTO :articlesDetails){
								%>
								<tr>
									<td>
								...
								<tr>
									...
									<td align="center" colspan="2">
										<input type="submit" alignment="center" value="Cancel">
									</td>
								</tr>
							</table>
